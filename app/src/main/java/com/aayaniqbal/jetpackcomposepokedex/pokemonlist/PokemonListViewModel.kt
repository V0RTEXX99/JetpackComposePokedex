package com.aayaniqbal.jetpackcomposepokedex.pokemonlist
...
import com.aayaniqbal.jetpackcomposepokedex.data.models.PokedexListEntry
import com.aayaniqbal.jetpackcomposepokedex.repository.PokemonRepository
import com.aayaniqbal.jetpackcomposepokedex.util.Constants.PAGE_SIZE
    ...
    fun calcDominantColor(
        ...
        Palette.from(bmp).generate {
            ...
            palette?.dominantSwatch?.rgb?.let {
                colorValue ->
                onFinish(Color(colorValue)) //returns the color value
            }
        }
    }
}